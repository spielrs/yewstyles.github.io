...
export interface InitOutput {
  ...
  readonly __wbgt_should_create_clickable_item_19: (a: number) => void;
  ...
  readonly __wbgt_should_create_form_submit_15: (a: number) => void;
  readonly __wbgt_should_create_form_textarea_16: (a: number) => void;
  ...
  readonly __wbgt_should_create_paragraph_text_28: (a: number) => void;
  ...
  readonly _dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h13d6bca93d0309af: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h022a373c2c9303ce: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hd894ff4777df17e2: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke3_mut__ha62cf83a344bdddd: (a: number, b: number, c: number, d: number, e: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h15baf9eec73886ef: (a: number, b: number, c: number, d: number) => void;
}
